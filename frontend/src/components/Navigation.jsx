            ...
            {!isAuthenticated ? (
              ...
              <>
                ...
                {user?.role === 'client' && (
                  <Link 
                    to="/find-cleaners" 
                    className="text-gray-700 hover:text-indigo-600 px-4 py-2 rounded-xl text-base font-semibold transition-all duration-200 hover:bg-indigo-50 flex items-center space-x-1"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {(user?.role === 'client' || user?.role === 'cleaner') && (
                  <Link 
                    to="/payments" 
                    className="text-gray-700 hover:text-blue-600 px-4 py-2 rounded-xl text-base font-semibold transition-all duration-200 hover:bg-blue-50 flex items-center space-x-1"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
