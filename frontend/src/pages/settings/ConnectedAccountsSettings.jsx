 ...
 * Shows OAuth providers and linked accounts
 */
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-gray-600">
          Manage OAuth providers and third-party integrations
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="border border-gray-200 rounded-lg p-4 flex items-center justify-between">
          ...
          <div>
            {user?.oauth_provider === 'google' ? (
              <span className="inline-flex items-center gap-2 px-3 py-1.5 bg-green-100 text-green-700 text-sm font-medium rounded-lg">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
        ...
        <div>
          <p className="text-sm font-medium text-blue-900">About Connected Accounts</p>
          <p className="mt-1 text-sm text-blue-700">
            Your account can be connected to OAuth providers for easier sign-in. 
            OAuth accounts cannot use email/password authentication for security reasons.
          </p>
        </div>
      </div>
    </div>
